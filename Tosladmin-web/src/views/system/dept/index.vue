  ...
  <div class="app-container">
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
      <el-form ref="form" inline :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item label="城市排序" prop="deptSort">
          <el-input-number
        ...
        <el-form-item v-if="form.isTop === '0'" style="margin-bottom: 0;" label="上级城市" prop="pid">
          <treeselect
            v-model="form.pid"
...
export default {
  ...
  cruds() {
    return CRUD({ title: '城市', url: 'api/dept', crudMethod: { ...crudDept }})
  },
  ...
  methods: {
    ...
    changeEnabled(data, val) {
      this.$confirm('此操作将 "' + this.dict.label.dept_status[val] + '" ' + data.name + '城市, 是否继续？', '提示', {
